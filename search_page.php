...
<div class="webpage">
    ...
    <div class="post_page">
        ...
        <div><a href="mainpage.php" id="home" ><i class="w3-xlarge"><i class="fa fa-home"> </i></i>Home</a></div>
            <i class="w3-xlarge" style="margin:3vh 0"><i class="fa fa-search"> </i></i>
        ...
        <div class="allposts">
            ...
            if($con->connect_error){
                ...
                $statement = "SELECT * FROM posts WHERE name_of_the_crop='{$name_of_crop}'";
